...
app.use(function(req, res, next) {
  var allowedOrigins = ['http://localhost:9000','http://localhost:3000','https://dry-sierra-81320.herokuapp.com','https://www.heshamelmasry.website','http://www.heshamelmasry.website'];
